...
class BarcodeScannerViewController: UIViewController {
    ...
    private func setConstraintsForControls() {
        ...
        flashIcon.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -35).isActive = true
        flashIcon.heightAnchor.constraint(equalToConstant: 45.0).isActive = true
        flashIcon.widthAnchor.constraint(equalToConstant: 45.0).isActive = true

        cancelButton.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -25).isActive = true
        cancelButton.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -35).isActive = true
        cancelButton.heightAnchor.constraint(equalToConstant: 45.0).isActive = true
        cancelButton.widthAnchor.constraint(equalToConstant: 45.0).isActive = true

        switchCameraButton.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 25).isActive = true
        switchCameraButton.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -35).isActive = true
        switchCameraButton.heightAnchor.constraint(equalToConstant: 45.0).isActive = true
        switchCameraButton.widthAnchor.constraint(equalToConstant: 45.0).isActive = true
